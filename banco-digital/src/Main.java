...
public abstract class Main {
	...
	public static void main(String[] args) {
		...
		String nome = JOptionPane.showInputDialog("Olá, cliente! Digite o seu nome:");
		...
		JOptionPane.showOptionDialog(null, "Selecione conta1 para Conta Corrente e conta2 para Conta Poupança",
